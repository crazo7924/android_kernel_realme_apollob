...
int mp2650_input_current_limit_write(int current_ma)
{
	...
	i = 3; /* 1350 */
	rc = mp2650_config_interface(REG00_MP2650_ADDRESS,
				     REG00_MP2650_1ST_CURRENT_LIMIT_1350MA,
				     REG00_MP2650_1ST_CURRENT_LIMIT_MASK);
	rc = mp2650_config_interface(REG0F_MP2650_ADDRESS,
				     REG00_MP2650_1ST_CURRENT_LIMIT_1350MA,
				     REG0F_MP2650_2ND_CURRENT_LIMIT_MASK);
	...
	i = 5; /* 1700 */
	rc = mp2650_config_interface(REG00_MP2650_ADDRESS,
				     REG00_MP2650_1ST_CURRENT_LIMIT_1700MA,
				     REG00_MP2650_1ST_CURRENT_LIMIT_MASK);
	rc = mp2650_config_interface(REG0F_MP2650_ADDRESS,
				     REG00_MP2650_1ST_CURRENT_LIMIT_1700MA,
				     REG0F_MP2650_2ND_CURRENT_LIMIT_MASK);
...
int mp2650_set_prechg_voltage_threshold(void)
{
	...
	mp2650_config_interface(REG07_MP2650_ADDRESS,
...
int mp2650_set_switching_frequency(void)
{
	...
	mp2650_config_interface(REG0B_MP2650_ADDRESS,
...
static int mp2650_vbus_avoid_electric_config(void)
{
	...
	mp2650_config_interface(REG39_MP2650_ADDRESS, 0x40, 0xff);
	mp2650_config_interface(REG08_MP2650_ADDRESS, 0x36, 0xff);
	mp2650_config_interface(REG08_MP2650_ADDRESS, 0x16, 0xff);
	mp2650_config_interface(REG39_MP2650_ADDRESS, 0x00, 0xff);
	mp2650_config_interface(REG53_MP2650_ADDRESS, 0x00, 0xff);
	mp2650_config_interface(REG2F_MP2650_ADDRESS, 0x15, 0xff);
	return 0;
}
