...
static int __debug_mask =
	PR_MISC | PR_OTG | PR_INTERRUPT | PR_REGISTER | PR_PARALLEL;
#else
	static int __debug_mask;
#endif
...
static void em_mode_enable(void)
{
	...
	chg_err("done\n");
	vote(g_oplus_chip->pmic_spmi.smb5_chip->chg.pl_disable_votable,
	     PL_DELAY_VOTER, false, 0);
	vote(g_oplus_chip->pmic_spmi.smb5_chip->chg.awake_votable,
	     PL_DELAY_VOTER, false, 0);
	return;
}
